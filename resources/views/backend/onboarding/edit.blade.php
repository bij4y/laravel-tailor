    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/onboarding/{{ $onboarding->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="container">
                                ...
                                <div class="form-group row">
                                    <label for="name">Text</label>
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder=""  value="{{ $onboading->name }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <img src="{{ asset($onboarding->feature) }}" alt="" srcset="" width="60">
